# Generated by Django 4.1.7 on 2023-03-05 05:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='avatar/avatar-default.png', upload_to='avatar/%Y/%m')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
        ...
        migrations.AddField(
            model_name='discount',
            name='admin',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='discounts', to='delivery.adminuser'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
